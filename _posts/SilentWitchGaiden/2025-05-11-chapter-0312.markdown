...
"Also," Monica continued. "I asked Lana... I mean, President Colette to submit an application for using the medical tools from Ambard."
...
"We believe that it may be possible to stabilize the returned skin by loading the mana arrangement into the magical tools being researched in Ambard. However, their large medical devices are still in the research phase and require multiple applications, so we entrusted Miss Colette with that part."
